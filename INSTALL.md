...
```sh
export VERSION=7 OS=linux ARCH=amd64  # change this as you need
...
compiling. E.g. to build the 4.3.7 release, checkout the
`v4.3.7` tag:

```sh
git checkout --recurse-submodules v4.3.7
```
...
```sh
export VERSION=4.3.7 # this is the singularity version, change as you need
