...
compiling. E.g. to build the 4.0.0-rc.1 release candidate, checkout the
`v4.0.0-rc.1` tag:

```sh
git checkout --recurse-submodules v4.0.0-rc.1
```
...
```sh
export VERSION=4.0.0-rc.1  # this is the singularity version, change as you need
