...
compiling. E.g. to build the 4.4.1 release, checkout the
`v4.4.1` tag:

```sh
git checkout --recurse-submodules v4.4.1
```
...
```sh
export VERSION=4.4.1 # this is the singularity version, change as you need
