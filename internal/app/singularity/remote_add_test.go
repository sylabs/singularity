...
func createValidCfgFile(t *testing.T) string {
	...
	cfg := remote.Config{
		...
		Remotes: map[string]*endpoint.Config{
			//nolint:gosec // hard coded credentials for testing purposes
			"random": {
				URI:   "validURI",
...
func TestRemoteAdd(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "3: invalid config file; invalid remote name; invalid URI; local; notDefault",
			cfgfile:     invalidCfgFile,
		...
		{
			name:        "4: invalid config file; invalid remote name; empty URI; local; notDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      false,
		...
		{
			name:        "7: valid config file; invalid remote name; empty URI; local; notDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      false,
		...
		{
			name:        "13: valid config file: invalid remote name; valid URI; local; notDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         validURI,
			global:      false,
		...
		{
			name:        "16: invalid config file; invalid remote name; invalid URI; global; notDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         invalidURI,
			global:      true,
		...
		{
			name:        "17: invalid config file; invalid remote name; invalid URI; global; notDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      true,
		...
		{
			name:        "20: valid config file; invalid remote name; invalid URI; global; notDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         invalidURI,
			global:      true,
		...
		{
			name:        "21: valid config file; invalid remote name; invalid URI; global; notDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      true,
		...
		{
			name:        "22: invalid config file path; invalid remote name; invalid URI; local; notDefault",
		...
		{
			name:        "23: invalid config file path; invalid remote name; invalid URI; global; notDefault",
			cfgfile:     invalidCfgFilePath,
			remoteName:  "",
			uri:         invalidURI,
			global:      true,
		...
		{
			name:        "24: invalid config file path; empty remote name; invalid URI; local; notDefault",
			cfgfile:     invalidCfgFilePath,
			remoteName:  validRemoteName,
			uri:         "",
			global:      false,
		...
		{
			name:        "33: invalid config file; invalid remote name; invalid URI; local; makeDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         invalidURI,
			global:      false,
		...
		{
			name:        "34: invalid config file; invalid remote name; empty URI; local; makeDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      false,
		...
		{
			name:        "37: valid config file; invalid remote name; empty URI; local; makeDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      false,
		...
		{
			name:        "43: valid config file: invalid remote name; valid URI; local; makeDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         validURI,
			global:      false,
		...
		{
			name:        "46: invalid config file; invalid remote name; invalid URI; global; makeDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         invalidURI,
			global:      true,
		...
		{
			name:        "47: invalid config file; invalid remote name; invalid URI; global; makeDefault",
			cfgfile:     invalidCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      true,
		...
		{
			name:        "50: valid config file; invalid remote name; invalid URI; global; makeDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         invalidURI,
			global:      true,
		...
		{
			name:        "51: valid config file; invalid remote name; invalid URI; global; makeDefault",
			cfgfile:     validCfgFile,
			remoteName:  validRemoteName,
			uri:         "",
			global:      true,
		...
		{
			name:        "52: invalid config file path; invalid remote name; invalid URI; local; makeDefault",
			cfgfile:     invalidCfgFilePath,
			remoteName:  validRemoteName,
			uri:         invalidURI,
			global:      false,
		...
		{
			name:        "53: invalid config file path; invalid remote name; invalid URI; global; makeDefault",
			cfgfile:     invalidCfgFilePath,
			remoteName:  "",
			uri:         invalidURI,
			global:      true,
		...
		{
			name:        "54: invalid config file path; empty remote name; invalid URI; local; makeDefault",
			cfgfile:     invalidCfgFilePath,
			remoteName:  validRemoteName,
			uri:         "",
			global:      false,
