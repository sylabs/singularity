...
Enterprise Performance Computing (EPC)`
  ...
  // get-login-password
  // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  GetLoginPasswordUse   string = `get-login-password`
  GetLoginPasswordShort string = `Retrieves the cli secret for the currently logged in user`
  GetLoginPasswordLong  string = `
  The 'get-login-password' command allows you to retrieve the cli secret for the currently user.`
  GetLoginPasswordExample string = `
  $ singularity get-login-password | docker login -u user --password-stdin https://harbor.sylabs.io`
